...
from .service import get_volunteer_statistics, get_activity_type_statistics, get_user_statistics, get_monthly_statistics
...
async def _get_user_statistics(
    ...
    if start_date or end_date or user_id:
        query = StatisticsQuery(start_date=start_date, end_date=end_date, user_id=user_id)
