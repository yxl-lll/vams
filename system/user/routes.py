...
from .model import UpPwdBody, User, UserBody, UserQuery
from .service import add, auth_role, delete, one, pages, upd_password, update
...
async def _authorize(
    user_id: Annotated[str, Form()], role_ids: Annotated[list[str], Form()]
):
