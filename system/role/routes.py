...
from .service import pages, add, delete, update, one, authorize, get_auth_menu, lists, get_auth_role
from .model import Role, RoleQuery, RoleBody
...
async def _authorize(role_id: Annotated[str, Form()], menu_ids: Annotated[list[str], Form()]):
